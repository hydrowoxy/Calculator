    ...
    <header className="bg-white md:sticky top-0 z-10 shadow-md">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-700	flex flex-wrap items-center text-base justify-center">
          ...
          <a href="#Calc2" className="mr-5 hover:bg-lightgray rounded mt-4 md:mt-0 px-2 hover:text-blue">
            Calculus 2
          </a>
          <a href="#Calc3" className="mr-5 hover:bg-lightgray rounded mt-4 md:mt-0 px-2 hover:text-blue">
            Calculus 3
          </a>
          <a href="#Discrete" className="mr-5 hover:bg-lightgray rounded mt-4 md:mt-0 px-2 hover:text-blue">
            Discrete Math
          </a>
        </nav>
        <a
